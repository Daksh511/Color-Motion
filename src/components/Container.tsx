...
import useMousePosition from 'src/lib/useMousePosition';
...
export default function Container(props: ContainerProps) {
  ...
  const meta = {
    title: "color & motion",
    description: `Design Comes to Life.`,
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:site_name" content="Color & Motion" />
      ...
      >
        ...
        >
          <Link href="/">
            <img src="/Black Logo1.png" className="mask" alt="Black Logo" />
            <img src="/White_Logo.png" className="body" alt="White Logo" />
            </Link>
        </motion.div> */}

        {/* Background logo */}
        <div className="mask-logo2">
          <Link href="/">
            <img src="/White_Logo.png" className="body" alt="White Logo" />
          </Link>
        </div>
